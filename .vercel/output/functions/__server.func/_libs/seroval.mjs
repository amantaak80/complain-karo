...
var re = () => {
  ...
  Rr = () => {
    ...
    return {
      ...
      throw: (l) => {
        t &&
          (e.push(l), s(l, "throw"), (t = false), (n = false), (r.length = 0));
      },
      return: (l) => {
        t &&
          (e.push(l), s(l, "return"), (t = false), (n = true), (r.length = 0));
      },
    };
  },
  vt = Rr.toString(),
...
async function Rn(e, r, t) {
  ...
  for (let a = 0, s = t.length; a < s; a++)
    a in t ? (n[a] = await N(e, r, t[a])) : (n[a] = 0);
  return n;
}
...
async function kr(e, r, t) {
  ...
  for (let i = 0, u = n.length; i < u; i++)
    (a.push(y(n[i][0])), s.push(await N(e, r, n[i][1])));
  return (
    C in t &&
...
function jt(e, r, t, n) {
  let a = t.k;
  if (a.length > 0)
    for (let i = 0, u = t.v, l = a.length; i < l; i++) Zn(e, r, n, a[i], u[i]);
  return n;
}
function $n(e, r, t) {
...
function Jr(e, r, t) {
  let n = Object.entries(t),
    ...
    s = [];
  for (let i = 0, u = n.length; i < u; i++)
    (a.push(y(n[i][0])), s.push(E(e, r, n[i][1])));
  return (
...
function Ta(e, r, t) {
  if (this.state.alive) {
    let n = G(this, r, t);
    (n && ie(this, c(23, e, o, o, o, o, o, [k(this.base, 2), n], o, o, o, o)),
      be(this));
  }
}
function wa(e, r, t) {
...
function ha(e, r, t, n) {
  let a = hr(e.base, {});
  return (
    e.type === 2 && (Xr(e), n.then(Ta.bind(e, a, r), wa.bind(e, a, r))),
    ht(e.base, t, a)
  );
}
function za(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    ...
    if (u.parse.sync && u.test(n))
      return fe(t, u.tag, u.parse.sync(n, new Gr(e, r), { id: t }));
  }
  return o;
}
