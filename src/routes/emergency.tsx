  ...
  return (
    <div className="px-4 pt-6">
        ...
        {contacts.map((c) => {
          ...
          return (
            ...
            >
              ...
              <p className="mt-2 text-lg font-extrabold tracking-wide text-foreground">
                {c.number}
              </p>
            </a>
          );
      ...
      <p className="mt-6 rounded-2xl border border-dashed border-border bg-muted/40 p-3 text-center text-[11px] text-muted-foreground">
        Numbers shown are official India emergency helplines. Stay calm and
        speak clearly.
      </p>
    </div>
  );
